...
(card_id VARCHAR(20) NOT NULL,
 ...
 country VARCHAR(20),
 PRIMARY KEY(card_id),
 FOREIGN KEY(event_name) REFERENCES fifa_events(event_name) ON DELETE SET NULL ON UPDATE CASCADE
);
...
(card_id VARCHAR(20) NOT NULL,
 ...
 shooting INTEGER,
 training_xp INTEGER,
 PRIMARY KEY(card_id, lvl),
 FOREIGN KEY(card_id) REFERENCES player_cards(card_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(card_id VARCHAR(20) NOT NULL,
 club_name VARCHAR(20) NOT NULL,
 PRIMARY KEY(card_id, club_name),
 FOREIGN KEY(card_id) REFERENCES player_cards(card_id) ON DELETE CASCADE ON UPDATE CASCADE ,
 FOREIGN KEY(club_name) REFERENCES clubs(club_name) ON UPDATE CASCADE
);
...
(fifa_id VARCHAR(20) NOT NULL,
 card_id VARCHAR(20) NOT NULL,
 lvl INTEGER NOT NULL,
 PRIMARY KEY(fifa_id, card_id, lvl),
 FOREIGN KEY(fifa_id) REFERENCES accounts(fifa_id) ON DELETE CASCADE ON UPDATE CASCADE,
 FOREIGN KEY(card_id, lvl) REFERENCES card_lvls(card_id, lvl) ON UPDATE CASCADE
);
...
('lg33km', 'Kylian Mbappe', 'RW', 91, 'Ligue 1', 'France'),
...
('pl27sa', 'Sergio Aguero', 'CF', 92, 'Premier League', 'Argentina'),
...
('lg40md', 'AS Saint-Etienne'),
('ll01lm', 'FC Barcelona'),
('ll02cr', 'Real Madrid'),
('ll03sr', 'Real Madrid'),
('ll04gm', 'Atletico Madrid'),
('ll05pq', 'FC Barcelona'),
('ll06ol', 'Atletico Madrid'),
('ll07ja', 'FC Barcelona'),
('ll08tk', 'Real Madrid'),
('ll09gg', 'FC Barcelona'),
('ll10sl', 'Atletico Madrid'),
('pi11pl', ''),
('pi12rn', ''),
('pi13vs', ''),
('pi14rd', ''),
...
('john4104', 'John', 'john12@gmail.com', '1234', 90000, 55000),
